    ...
    public partial class addroomid : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, "CONCURRENCY_STAMP", "admin@gmail.com", true, "Admin User", "", false, null, "ADMIN@GMAIL.COM", "ADMIN", "AQAAAAIAAYagAAAAEPOLBAYr/5DCimNYduRExDCzOSnu0kJpQEAYlZDEoWXVUZ/LuJOQEWCqp3qm7RB4ZA==", null, false, "", false, "admin" },
                    { 2, 0, "CONCURRENCY_STAMP", "user1@gmail.com", true, "User Test 1", "", false, null, "USER1@GMAIL.COM", "USER1", "AQAAAAIAAYagAAAAENqAWmOUUrNEweIQ/SAg0ffvLCi4eXk8KXqIz8ohS0Usriq0JPWVKTFkMO6AxtjJeA==", null, false, "", false, "user1" },
                    { 3, 0, "CONCURRENCY_STAMP", "user2@gmail.com", true, "User Test 2", "", false, null, "USER2@GMAIL.COM", "USER2", "AQAAAAIAAYagAAAAEEjqTmjf5j+1K/0aSHK8YZzfJR+GsGfit1q/BtKO7mRtSsiRy64TdTMpGzoNMSZIsg==", null, false, "", false, "user2" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Habitaciones", 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Una de las cortinas de la ventana principal presenta deterioro en el sistema de apertura. Falta el cordón", 0, 1, "A-101", "ToDo", "Daño en Velo Ventana" },
                    { 2, "Baños", 2, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "La cisterna presenta flujo continuo de agua, se hizo revision manual pero persiste problema, se solicita visita concerje", 0, 1, "A-102", "ToDo", "Cisterna presenta fuga" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, new DateTime(2023, 11, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), null, new DateTime(2023, 11, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, "1", 2, "Guest1@example.com", "Guest1", null, 0, 0, null, "W2356021", null, null, 0, null },
                    { 2, null, new DateTime(2023, 11, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), null, new DateTime(2023, 11, 9, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, "2", 2, "Guest2@example.com", "Guest2", null, 0, 0, null, "W2356022", null, null, 0, null },
                    { 3, null, new DateTime(2023, 11, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), null, new DateTime(2023, 11, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, "3", 2, "Guest3@example.com", "Guest3", null, 0, 0, null, "W2356023", null, null, 0, null }
                });
